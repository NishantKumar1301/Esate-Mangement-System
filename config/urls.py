...
schema_view = get_schema_view(
    openapi.Info(
        title="Nishant Apartments API",
        default_version="v1",
        description="An Apartment Management API for Real Estate",
        contact=openapi.Contact(email="nishantkumarfps@gmail.com"),
...
admin.site.site_header = "Nishant Apartments Admin"
admin.site.site_title = "Nishant Apartments Admin Portal"
admin.site.index_title = "Welcome to Nishant Apartments Admin Portal"